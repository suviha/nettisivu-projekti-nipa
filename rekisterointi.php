<?php include ('palvelin.php')/*sisällyttää palvelimeen tehdyt säännöt*/
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="osiot">
		...
		<div class="paaosio">
			...
			<form method="post" action="rekisterointi.php" >
				...
				<button type="submit" class="btn" name="rek_kayt"> Rekisteröidy </button>
			
				<p>Omistat jo tunnukset? <a href="login.php"><b>Kirjaudu sisään</b></a></p>
